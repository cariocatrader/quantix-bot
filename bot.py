...
# =========================
# GET_RESULT_RAW - 300 velas + fuso UTC explícito
# =========================
def get_result_raw(direction, coin_id, target_time_dt):
    ...
    try:
        ...
        print(f"🔍 Procurando candle 1m para {target_time_dt.strftime('%H:%M')} (ex: 11:40) ou +1 min")

        candle_found = None
        # aumentar janela: 300 velas (5 minutos de 1m) para trás
...
print("🚀 QUANTIX PRO ATIVO (65s, janela 300 velas, fuso UTC explícito, exigir candle 1m correto, GIF + botão no final)")
