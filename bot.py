...
# ==============================
# SINCRONIZAÇÃO REAL (API TIMESTAMP)
# ==============================
...
def run(c):
    ...
    if not candles or len(candles) < 3:
        ...
        bot.send_message(c.message.chat.id, "⚠️ Dados do mercado indisponíveis. Tente novamente.")
        return
...
"""
    ...
    bot.send_message(c.message.chat.id, "🔁 Finalizado", reply_markup=kb)
