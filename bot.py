        ...
        for i in range(len(data)-1, max(-1, len(data)-100), -1):
            ...
            try:
                ...
                if (candle_dt.year == target_year and
                    ...
                    entry_time_text = target_time_dt.strftime("%H:%M")   # 21:34
                    candle_time = candle_dt.strftime("%H:%M")           # 21:26/21:27
...
Se você pedir às 21:33:
✨ Entrada = 21:34
📅 O resultado aparece após 65s a partir de 21:34:00 (≈ 21:35:05)
🎯 O texto de entrada no Telegram sempre usa 21:34, mesmo que o candle verificado seja 21:26/21:27
    """
