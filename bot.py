...
# === ANALISE COM 1 CHAMADA (sem days) ===
def analyze(coin_id):
    """
    1 requisição para OHLC (sem parâmetro days) + pega 5 velas recentes.
    """
    ...
    try:
        ...
        params = {"vs_currency": "usd"}  # sem days
...
# === CANDLE EXATO DO HORÁRIO DE ENTRADA (sem days) ===
...
print(f"🚀 QUANTIX ATIVO {get_br_time()} - 1 chamada CoinGecko por sinal (sem days)")
bot.remove_webhook()
time.sleep(2)
