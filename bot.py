...
# =========================
# RESULTADO (RAW) - AJUSTADO PARA ESPERAR 65s E ENCONTRAR CANDLE CERTO
# =========================
def get_result_raw(direction, coin_id, target_time_dt):
    ...
    try:
        ...
        # Reverter para começar do mais recente
        for row in reversed(data):
            ...
            # Procurar o candle que corresponde ao minuto da entrada ou o próximo
        ...
        # Se não achar a vela alinhada, usa a última vela como fallback
        if data:
            row = data[-1]
            if len(row) >= 5:
                ts = row[0] / 1000
