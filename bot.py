...
# =========================
# GET_RESULT_RAW - SEM FALBACK, SEMPRE CANDLE 1M CORRETO
# =========================
...
def pair(c):
    ...
    user审计 chat_id]["coin_id"] = coin_id
...
print("🚀 QUANTIX PRO ATIVO (65s, sem fallback antigo, exigir candle 1m correto, GIF + botão no final)")
