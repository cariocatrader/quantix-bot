...
# =========================
# ANALYZE - TENDÊNCIA COM BYBIT (sem CoinGecko, com retries)
# =========================
    ...
    for tentativa in range(3):
        try:
            ...
            if r.status_code == 429:
                print("❌ Bybit 429 (rate limit), tentando novamente...")
                time.sleep(10)
                continue
...
def menu_paridades(chat_id):
    ...
    # Garantir que user_state[chat_id] existe
...
"""
    ...
    # Garantir inicialização mínima do user_state[chat_id]
    if chat_id not in user_state:
        user_state[chat_id] = {}
