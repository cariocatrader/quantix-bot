...
# 2) Resultado só depois de 65s a partir do minuto exato de entrada (ex: 20:07:00 → resultado após 20:08:05)
    ...
    try:
        ...
        for i in range(len(data)-1, max(-1, len(data)-100), -1):
            ...
            try:
                ...
                # aceita o candle de 20:07 ou 20:08 (se já estiver lá)
